###########################################################################
## Makefile generated for component 'uav_altitude_hold'. 
## 
## Makefile     : uav_altitude_hold.mk
## Generated on : Fri Aug 21 12:59:28 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/uav_altitude_hold.exe
...
PRODUCT_NAME              = uav_altitude_hold
MAKEFILE                  = uav_altitude_hold.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2026a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2026a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/SEBAHA~1.BAB/Desktop/WEBINA~1/UAV-AL~1/scripts
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = uav_altitude_hold_comp.rsp
CMD_FILE                  = uav_altitude_hold.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/uav_altitude_hold.exe
...
DEFINES_STANDARD = -DMODEL=uav_altitude_hold -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/uav_altitude_hold_ert_rtw/uav_altitude_hold.c

MAIN_SRC = $(START_DIR)/uav_altitude_hold_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/uav_altitude_hold_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/uav_altitude_hold_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/uav_altitude_hold_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/uav_altitude_hold_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/uav_altitude_hold_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.obj : $(START_DIR)/uav_altitude_hold_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


uav_altitude_hold.obj : $(START_DIR)/uav_altitude_hold_ert_rtw/uav_altitude_hold.c
	$(CC) $(CFLAGS) -o "$@" "$<"
